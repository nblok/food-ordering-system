...
class OrderCreateCommandHandler:
    ...
    def __init__(
        ...
        self.order_created_payment_request_message_publisher = order_created_payment_request_message_publisher
    ...
    def create_order(self, command: CreateOrderCommand) -> CreateOrderResponse:
        ...
        self.order_created_payment_request_message_publisher.publish(order_created_event)
