import logging
from order_service.order_domain.application_service.dto.track.track_order_query import (
    TrackOrderQuery,
)
...
from order_service.order_domain.application_service.ports.output.repository.order_repository import (
    OrderRepository,
)
from order_service.order_domain.domain_core.exception.order_not_found_exception import (
    ...
    def track_order(self, query: TrackOrderQuery) -> TrackOrderResponse:
        ...
        if order is None:
            ...
            raise OrderNotFoundException(
                f"Order with tracking ID {query.tracking_id} not found"
            )
